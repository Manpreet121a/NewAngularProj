...
import { DialogOverviewExampleDialogComponent } from './getdatafrommongo/dialog-overview-example-dialog/dialog-overview-example-dialog.component';
import { EmployeeDataService } from './getdatafrommongo/employeedata.service';

@NgModule({
  declarations: [
    AppComponent,
    GetdatacomponentComponent,
    GetdatafrommongoComponent,
  ...
  providers: [GetsqldataserviceService,
    EmployeeDataService,
